...
import com.yusong.baseproject.R;
...
public class ProgressWheel extends View {
    ...
    private void parseAttributes(TypedArray a) {
        barWidth = (int) a.getDimension(R.styleable.ProgressWheel_PWbarWidth,
                barWidth);

        rimWidth = (int) a.getDimension(R.styleable.ProgressWheel_PWrimWidth,
                rimWidth);

        spinSpeed = (int) a.getDimension(R.styleable.ProgressWheel_PWspinSpeed,
                spinSpeed);

        delayMillis = a.getInteger(R.styleable.ProgressWheel_PWdelayMillis,
                delayMillis);
        if (delayMillis < 0) {
            delayMillis = 0;
        }
        ...
        barLength = (int) a.getDimension(R.styleable.ProgressWheel_PWbarLenth,
                barLength);

        textSize = (int) a.getDimension(R.styleable.ProgressWheel_PWtextSize,
                textSize);

        textColor = (int) a.getColor(R.styleable.ProgressWheel_PWtextColor,
                textColor);
        ...
        rimColor = (int) a.getColor(R.styleable.ProgressWheel_PWrimColor,
                rimColor);

        circleColor = (int) a.getColor(R.styleable.ProgressWheel_PWcircleColor,
                circleColor);
